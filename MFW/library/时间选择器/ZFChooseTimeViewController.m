...
- (void)collectionView:(UICollectionView *)collectionView didSelectItemAtIndexPath:(NSIndexPath *)indexPath{
    ...
    if (self.OutDateArray.count == 0) {
        ...
        if (p_0 < p_1) {
            ...
            [SVProgressHUD showErrorWithStatus:@"选择入住时间不能小于离店时间!" duration:1.5];
            return;
...
- (void)showAlertController
{
    ...
    UIAlertController *alertController = [UIAlertController alertControllerWithTitle:@"" message:@"是否选择入住时间?" preferredStyle:UIAlertControllerStyleAlert];
